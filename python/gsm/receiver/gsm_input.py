...
# Author: Piotr Krysik
# Description: Adaptor of input stream for the GSM receiver.
# Contains frequency ofset corrector doing also resampling to
# integer multiplies of GSM sample rate and LP filter filtering
# GSM channel.
