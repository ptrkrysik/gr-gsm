...
/* BINDTOOL_HEADER_FILE_HASH(832e45712d5052db1d85d605a03a2638)                     */
/***********************************************************************************/
...
void bind_tch_f_decoder(py::module& m)
{
    ...
    py::class_<tch_f_decoder, gr::block, gr::basic_block, std::shared_ptr<tch_f_decoder>>(
        m, "tch_f_decoder", D(tch_f_decoder))

        .def(py::init(&tch_f_decoder::make), py::arg("mode"), py::arg("boundary_check") = false, D(tch_f_decoder, make))
