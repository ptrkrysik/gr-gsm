...
tch_f_chans_demapper::sptr tch_f_chans_demapper::make(unsigned int timeslot_nr)
{
    return gnuradio::get_initial_sptr(new tch_f_chans_demapper_impl(timeslot_nr));
}
...
tch_f_chans_demapper_impl::tch_f_chans_demapper_impl(unsigned int timeslot_nr)
    : gr::block("tch_f_chans_demapper", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0)),
      d_timeslot(timeslot_nr)

{
    message_port_register_in(pmt::mp("bursts"));
    set_msg_handler(pmt::mp("bursts"),
                    boost::bind(&tch_f_chans_demapper_impl::filter_tch_chans, this, boost::placeholders::_1));
...
void tch_f_chans_demapper_impl::sacch_tch_demapper(uint32_t fn_mod13,
                                                   u_int32_t fn_mod26,
                                                   uint32_t frame_nr,
