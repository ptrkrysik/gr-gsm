...
extract_immediate_assignment_impl::extract_immediate_assignment_impl(bool print_immediate_assignments,
    ...
    : gr::block("extract_immediate_assignment", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
    ...
    set_msg_handler(pmt::mp("msgs"),
                    boost::bind(&extract_immediate_assignment_impl::process_message, this, boost::placeholders::_1));
}
