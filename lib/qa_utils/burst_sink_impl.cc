...
burst_sink::sptr burst_sink::make() { return gnuradio::get_initial_sptr(new burst_sink_impl()); }

/*
 * The private constructor
 */
burst_sink_impl::burst_sink_impl()
    : gr::block("burst_sink", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0)), d_bursts(pmt::PMT_NIL)
{
...
std::vector<int> burst_sink_impl::get_framenumbers() { return d_framenumbers; }

std::vector<int> burst_sink_impl::get_timeslots() { return d_timeslots; }

std::vector<std::string> burst_sink_impl::get_burst_data() { return d_burst_data; }
pmt::pmt_t burst_sink_impl::get_bursts() { return d_bursts; }
std::vector<uint8_t> burst_sink_impl::get_sub_types() { return d_sub_types; }
std::vector<uint8_t> burst_sink_impl::get_sub_slots() { return d_sub_slots; }
} /* namespace gsm */
} /* namespace gr */
