...
message_printer::make(pmt::pmt_t prepend_string, bool prepend_fnr, bool prepend_frame_count, bool print_gsmtap_header)
{
    return gnuradio::get_initial_sptr(
        new message_printer_impl(prepend_string, prepend_fnr, prepend_frame_count, print_gsmtap_header));
}
...
message_printer_impl::message_printer_impl(pmt::pmt_t prepend_string,
    ...
    : gr::block("message_printer", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
