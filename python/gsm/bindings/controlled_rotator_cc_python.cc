...
/* BINDTOOL_HEADER_FILE_HASH(9029d8dcb13cdc8ca339edd292b425cc)                     */
/***********************************************************************************/
...
void bind_controlled_rotator_cc(py::module& m)
{
    ...
    py::class_<controlled_rotator_cc,
               gr::sync_block,
               gr::block,
               gr::basic_block,
               std::shared_ptr<controlled_rotator_cc>>(m, "controlled_rotator_cc", D(controlled_rotator_cc))

        .def(py::init(&controlled_rotator_cc::make), py::arg("phase_inc"), D(controlled_rotator_cc, make))


        .def("set_phase_inc",
             &controlled_rotator_cc::set_phase_inc,
             py::arg("phase_inc"),
