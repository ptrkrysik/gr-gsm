...
/* BINDTOOL_HEADER_FILE_HASH(913abe6958177291c1b8e256b1f09909)                     */
/***********************************************************************************/
...
void bind_universal_ctrl_chans_demapper(py::module& m)
{
    ...
    py::class_<universal_ctrl_chans_demapper,
               gr::block,
               gr::basic_block,
               std::shared_ptr<universal_ctrl_chans_demapper>>(
        m, "universal_ctrl_chans_demapper", D(universal_ctrl_chans_demapper))
